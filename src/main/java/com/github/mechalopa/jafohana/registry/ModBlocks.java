...
//	public static final Supplier<Block> FOX_AND_CUBS = REGISTRY.register("fox_and_cubs", () -> new ModFlowerBlock(MobEffects.FIRE_RESISTANCE, 4.0F));
//	public static final Supplier<Block> PINK_HAWKS_BEARD = REGISTRY.register("pink_hawks_beard", () -> new ModFlowerBlock(MobEffects.FIRE_RESISTANCE, 4.0F));
//	public static final Supplier<Block> LADIES_TRESSES = REGISTRY.register("ladies_tresses", () -> new ModFlowerBlock(MobEffects.FIRE_RESISTANCE, 4.0F));
//	public static final Supplier<Block> MECONOPSIS = REGISTRY.register("meconopsis", () -> new ModFlowerBlock(MobEffects.FIRE_RESISTANCE, 4.0F));
//	public static final Supplier<Block> APRICOT_MALLOW = REGISTRY.register("apricot_mallow", () -> new ModFlowerBlock(MobEffects.FIRE_RESISTANCE, 4.0F));
//	public static final Supplier<Block> SEGO_LILY = REGISTRY.register("sego_lily", () -> new ModFlowerBlock(MobEffects.SATURATION, 0.35F));
