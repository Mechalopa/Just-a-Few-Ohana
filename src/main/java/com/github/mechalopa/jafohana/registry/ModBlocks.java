...
public class ModBlocks
{
	...
	public static final Supplier<Block> POTTED_FORGET_ME_NOT = REGISTRY.register("potted_forget_me_not", () -> ModFlowerPotBlock.create(FORGET_ME_NOT.get()));
	public static final Supplier<Block> POTTED_YELLOW_AFRICAN_DAISY = REGISTRY.register("potted_yellow_african_daisy", () -> ModFlowerPotBlock.create(YELLOW_AFRICAN_DAISY.get()));
	public static final Supplier<Block> POTTED_PINK_AFRICAN_DAISY = REGISTRY.register("potted_pink_african_daisy", () -> ModFlowerPotBlock.create(PINK_AFRICAN_DAISY.get()));
	public static final Supplier<Block> POTTED_WHITE_AFRICAN_DAISY = REGISTRY.register("potted_white_african_daisy", () -> ModFlowerPotBlock.create(WHITE_AFRICAN_DAISY.get()));
	public static final Supplier<Block> POTTED_BLACK_TULIP = REGISTRY.register("potted_black_tulip", () -> ModFlowerPotBlock.create(BLACK_TULIP.get()));
	public static final Supplier<Block> POTTED_GREEN_TULIP = REGISTRY.register("potted_green_tulip", () -> ModFlowerPotBlock.create(GREEN_TULIP.get()));
	public static final Supplier<Block> POTTED_BLOOD_RED_IRIS = REGISTRY.register("potted_blood_red_iris", () -> ModFlowerPotBlock.create(BLOOD_RED_IRIS.get()));
	public static final Supplier<Block> POTTED_RED_SNAPDRAGON = REGISTRY.register("potted_red_snapdragon", () -> ModFlowerPotBlock.create(RED_SNAPDRAGON.get()));
	public static final Supplier<Block> POTTED_YELLOW_SNAPDRAGON = REGISTRY.register("potted_yellow_snapdragon", () -> ModFlowerPotBlock.create(YELLOW_SNAPDRAGON.get()));
	public static final Supplier<Block> POTTED_PINK_SNAPDRAGON = REGISTRY.register("potted_pink_snapdragon", () -> ModFlowerPotBlock.create(PINK_SNAPDRAGON.get()));
	public static final Supplier<Block> POTTED_WHITE_EGRET_ORCHID = REGISTRY.register("potted_white_egret_orchid", () -> ModFlowerPotBlock.create(WHITE_EGRET_ORCHID.get()));
	public static final Supplier<Block> POTTED_ORANGE_SPIDER_LILY = REGISTRY.register("potted_orange_spider_lily", () -> ModFlowerPotBlock.create(ORANGE_SPIDER_LILY.get()));
	public static final Supplier<Block> POTTED_PEPPERMINT_SPIDER_LILY = REGISTRY.register("potted_peppermint_spider_lily", () -> ModFlowerPotBlock.create(PEPPERMINT_SPIDER_LILY.get()));
	public static final Supplier<Block> POTTED_DANCING_LADIES_GINGER = REGISTRY.register("potted_dancing_ladies_ginger", () -> ModFlowerPotBlock.create(DANCING_LADIES_GINGER.get()));
	public static final Supplier<Block> POTTED_FIREBALL_LILY = REGISTRY.register("potted_fireball_lily", () -> ModFlowerPotBlock.create(FIREBALL_LILY.get()));
	public static final Supplier<Block> POTTED_SPATHIPHYLLUM = REGISTRY.register("potted_spathiphyllum", () -> ModFlowerPotBlock.create(SPATHIPHYLLUM.get()));
	public static final Supplier<Block> POTTED_PURPLE_PANSY = REGISTRY.register("potted_purple_pansy", () -> ModFlowerPotBlock.create(PURPLE_PANSY.get()));
	public static final Supplier<Block> POTTED_WHITE_PANSY = REGISTRY.register("potted_white_pansy", () -> ModFlowerPotBlock.create(WHITE_PANSY.get()));
	public static final Supplier<Block> POTTED_YELLOW_PANSY = REGISTRY.register("potted_yellow_pansy", () -> ModFlowerPotBlock.create(YELLOW_PANSY.get()));
	public static final Supplier<Block> POTTED_CREEPANSY = REGISTRY.register("potted_creepansy", () -> ModFlowerPotBlock.create(CREEPANSY.get()));
	public static final Supplier<Block> POTTED_SNOWDROP = REGISTRY.register("potted_snowdrop", () -> ModFlowerPotBlock.create(SNOWDROP.get()));
	public static final Supplier<Block> POTTED_WINTER_HEATH = REGISTRY.register("potted_winter_heath", () -> ModFlowerPotBlock.create(WINTER_HEATH.get()));
	public static final Supplier<Block> POTTED_BLUE_DAISY = REGISTRY.register("potted_blue_daisy", () -> ModFlowerPotBlock.create(BLUE_DAISY.get()));
	public static final Supplier<Block> POTTED_CRIMSON_CLOVER = REGISTRY.register("potted_crimson_clover", () -> ModFlowerPotBlock.create(CRIMSON_CLOVER.get()));
	...
	public static final Supplier<Block> POTTED_SEGO_LILY = REGISTRY.register("potted_sego_lily", () -> ModFlowerPotBlock.create(SEGO_LILY.get()));
	public static final Supplier<Block> POTTED_SEA_HOLLY = REGISTRY.register("potted_sea_holly", () -> ModFlowerPotBlock.create(SEA_HOLLY.get()));
	public static final Supplier<Block> POTTED_SEA_THRIFT = REGISTRY.register("potted_sea_thrift", () -> ModFlowerPotBlock.create(SEA_THRIFT.get()));
	public static final Supplier<Block> POTTED_HAREBELL = REGISTRY.register("potted_harebell", () -> ModFlowerPotBlock.create(HAREBELL.get()));
	public static final Supplier<Block> POTTED_MECONOPSIS = REGISTRY.register("potted_meconopsis", () -> ModFlowerPotBlock.create(MECONOPSIS.get()));
	public static final Supplier<Block> POTTED_WHEEL_LILY = REGISTRY.register("potted_wheel_lily", () -> ModFlowerPotBlock.create(WHEEL_LILY.get()));
	public static final Supplier<Block> POTTED_JACK_IN_THE_PULPIT = REGISTRY.register("potted_jack_in_the_pulpit", () -> ModFlowerPotBlock.create(JACK_IN_THE_PULPIT.get()));
	public static final Supplier<Block> POTTED_RED_SPIDER_LILY = REGISTRY.register("potted_red_spider_lily", () -> ModFlowerPotBlock.create(RED_SPIDER_LILY.get()));
	public static final Supplier<Block> POTTED_BELLS_OF_IRELAND = REGISTRY.register("potted_bells_of_ireland", () -> ModFlowerPotBlock.create(BELLS_OF_IRELAND.get()));
	public static final Supplier<Block> POTTED_BEACH_SPIDER_LILY = REGISTRY.register("potted_beach_spider_lily", () -> ModFlowerPotBlock.create(BEACH_SPIDER_LILY.get()));
