...
public class ModEventBusSubscriber
{
	...
	public static void setup(final FMLCommonSetupEvent event)
	{
		...
		ModConfiguredFeatures.RED_SPIDER_LILY_SPOOKY_FOREST = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(JAFOhana.MODID, "red_spider_lily_spooky_forest"), Feature.FLOWER.configured((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(ModBlocks.RED_SPIDER_LILY.get().defaultBlockState()), SimpleBlockPlacer.INSTANCE)).tries(64).build()).decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_SQUARE).chance(4));
	}
